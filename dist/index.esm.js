...
var Icon$q = function (props) {
    return (React.createElement("img", { width: "331px", height: "50px", src: "/images/mobile-logo.png" }));
};
...
var Icon$w = function (props) {
    return (React.createElement("img", { width: "64px", height: "64px", src: "/images/pancakes.png" }));
};
...
var RotatingPancakeIcon = styled(Icon$L)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled(Icon$K)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Logo = function (_a) {
    ...
    return (React.createElement("img", { width: "331px", height: "50px", src: logoImg }));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$P, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$O, { width: "24px", color: "textSubtle" }))),
...
var _a$2, _b$1;
var SCAN_URL = (_a$2 = {},
    _a$2[ChainId.MAINNET] = 'https://bscscan.com/address/',
    _a$2[ChainId.BSCTESTNET] = 'https://bscscan.com/address/',
    _a$2[ChainId.FANTOMNET] = 'https://ftmscan.com/address/',
    _a$2[ChainId.FANTOMTESTNET] = 'https://ftmscan.com/address/',
    _a$2[ChainId.HARMONYNET] = 'https://explorer.harmony.one/address/',
    _a$2[ChainId.HARMONYTESTNET] = 'https://explorer.harmony.one/address/',
    _a$2);
var SCAN_NAME = (_b$1 = {},
    _b$1[ChainId.MAINNET] = 'BscScan',
    _b$1[ChainId.BSCTESTNET] = 'BscScan',
    _b$1[ChainId.FANTOMNET] = 'FtmScan',
    _b$1[ChainId.FANTOMTESTNET] = 'FtmScan',
    _b$1[ChainId.HARMONYNET] = 'Harmony Explorer',
    _b$1[ChainId.HARMONYTESTNET] = 'Harmony Explorer',
    _b$1);
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } },
            account,
            " ",
            chainId),
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "" + SCAN_URL[chainId] + account, mr: "16px" },
                "View on ",
                SCAN_NAME[chainId]),
...
var useWalletModal = function (login, logout, account, chainId) {
    ...
    var onPresentAccountModal = useModal(React.createElement(AccountModal, { account: account || "", chainId: chainId || 56, logout: logout }))[0];
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                React.createElement(UserBlock$1, { account: account, login: login, logout: logout, chainId: chainId }))),
...
var StyledLink$2 = styled(Link$1)(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
}, function (_a) {
    var theme = _a.theme;
...
var Logo$3 = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Logo, { className: "desktop-icon", isDark: isDark })));
    return (React.createElement(Flex, null, isAbsoluteUrl ? (React.createElement(StyledLink$2, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React.createElement(StyledLink$2, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
var HorizentalLogo = React.memo(Logo$3, function (prev, next) { return prev.isDark === next.isDark; });
var templateObject_1$L;

var Wrapper$2 = styled.div(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var StyledNav$1 = styled.nav(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? 0 : "-" + MENU_HEIGHT + "px");
}, MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
...
var BodyWrapper$1 = styled.div(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
var Inner$1 = styled.div(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", "px;\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  margin-left: 0;\n  max-width: 100%;\n"], ["\n  flex-grow: 1;\n  margin-top: ", "px;\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  margin-left: 0;\n  max-width: 100%;\n"])), MENU_HEIGHT);
var HorizentalMenu = function (_a) {
    ...
    return (React.createElement(Wrapper$2, null,
        React.createElement(StyledNav$1, { showMenu: showMenu },
            React.createElement(HorizentalLogo, { isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React.createElement(Flex, null,
                React.createElement(UserBlock$1, { account: account, login: login, logout: logout, chainId: chainId }))),
