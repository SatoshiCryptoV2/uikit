...
var sdk = require('@satoshicrypto/sdk');
...
var Icon$q = function (props) {
    return (React__default['default'].createElement("img", { width: "331px", height: "50px", src: "/images/mobile-logo.png" }));
};
...
var Icon$w = function (props) {
    return (React__default['default'].createElement("img", { width: "64px", height: "64px", src: "/images/pancakes.png" }));
};
...
var Icon$J = function (props) {
    return (React__default['default'].createElement(Svg, { viewBox: "0 0 24 24" },
...
var RotatingPancakeIcon = styled__default['default'](Icon$L)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled__default['default'](Icon$K)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement("img", { width: "331px", height: "50px", src: logoImg }));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$P, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$O, { width: "24px", color: "textSubtle" }))),
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/SatoshiCryptoDefi/",
                target: '_blank',
            },
            {
                label: "Docs",
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, null,
        ...
        React__default['default'].createElement(Text, { color: "text", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var _a$2, _b$1;
var SCAN_URL = (_a$2 = {},
    _a$2[sdk.ChainId.MAINNET] = 'https://bscscan.com/address/',
    _a$2[sdk.ChainId.BSCTESTNET] = 'https://bscscan.com/address/',
    _a$2[sdk.ChainId.FANTOMNET] = 'https://ftmscan.com/address/',
    _a$2[sdk.ChainId.FANTOMTESTNET] = 'https://ftmscan.com/address/',
    _a$2[sdk.ChainId.HARMONYNET] = 'https://explorer.harmony.one/address/',
    _a$2[sdk.ChainId.HARMONYTESTNET] = 'https://explorer.harmony.one/address/',
    _a$2);
var SCAN_NAME = (_b$1 = {},
    _b$1[sdk.ChainId.MAINNET] = 'BscScan',
    _b$1[sdk.ChainId.BSCTESTNET] = 'BscScan',
    _b$1[sdk.ChainId.FANTOMNET] = 'FtmScan',
    _b$1[sdk.ChainId.FANTOMTESTNET] = 'FtmScan',
    _b$1[sdk.ChainId.HARMONYNET] = 'Harmony Explorer',
    _b$1[sdk.ChainId.HARMONYTESTNET] = 'Harmony Explorer',
    _b$1);
var AccountModal = function (_a) {
    var account = _a.account, chainId = _a.chainId, logout = _a.logout, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        React__default['default'].createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px" } },
            account,
            " ",
            chainId),
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "" + SCAN_URL[chainId] + account, mr: "16px" },
                "View on ",
                SCAN_NAME[chainId]),
...
var useWalletModal = function (login, logout, account, chainId) {
    var onPresentConnectModal = useModal(React__default['default'].createElement(ConnectModal, { login: login }))[0];
    var onPresentAccountModal = useModal(React__default['default'].createElement(AccountModal, { account: account || "", chainId: chainId || 56, logout: logout }))[0];
    return { onPresentConnectModal: onPresentConnectModal, onPresentAccountModal: onPresentAccountModal };
};

var UserBlock = function (_a) {
    var account = _a.account, chainId = _a.chainId, login = _a.login, logout = _a.logout;
    var _b = useWalletModal(login, logout, account, chainId), onPresentConnectModal = _b.onPresentConnectModal, onPresentAccountModal = _b.onPresentAccountModal;
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, chainId = _a.chainId, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links; _a.profile; var children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock$1, { account: account, login: login, logout: logout, chainId: chainId }))),
...
var StyledLink$2 = styled__default['default'](reactRouterDom.Link)(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 156px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
}, function (_a) {
    var theme = _a.theme;
...
var Logo$3 = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(Logo, { className: "desktop-icon", isDark: isDark })));
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$2, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$2, { to: href, "aria-label": "Pancake home page" }, innerLogo))));
};
var HorizentalLogo = React__default['default'].memo(Logo$3, function (prev, next) { return prev.isDark === next.isDark; });
var templateObject_1$L;

var Wrapper$2 = styled__default['default'].div(templateObject_1$M || (templateObject_1$M = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var StyledNav$1 = styled__default['default'].nav(templateObject_2$h || (templateObject_2$h = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? 0 : "-" + MENU_HEIGHT + "px");
}, MENU_HEIGHT, function (_a) {
    var theme = _a.theme;
...
var BodyWrapper$1 = styled__default['default'].div(templateObject_3$9 || (templateObject_3$9 = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n"], ["\n  position: relative;\n  display: flex;\n"])));
var Inner$1 = styled__default['default'].div(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  flex-grow: 1;\n  margin-top: ", "px;\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  margin-left: 0;\n  max-width: 100%;\n"], ["\n  flex-grow: 1;\n  margin-top: ", "px;\n  transition: margin-top 0.2s;\n  transform: translate3d(0, 0, 0);\n  margin-left: 0;\n  max-width: 100%;\n"])), MENU_HEIGHT);
var HorizentalMenu = function (_a) {
    var _b;
    var account = _a.account, chainId = _a.chainId, login = _a.login, logout = _a.logout, isDark = _a.isDark, links = _a.links, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper$2, null,
        React__default['default'].createElement(StyledNav$1, { showMenu: showMenu },
            React__default['default'].createElement(HorizentalLogo, { isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock$1, { account: account, login: login, logout: logout, chainId: chainId }))),
        React__default['default'].createElement(BodyWrapper$1, null,
            React__default['default'].createElement(Inner$1, null, children))));
};
var templateObject_1$M, templateObject_2$h, templateObject_3$9, templateObject_4$4;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#261d13", invertedContrast: "#FFFFFF", input: "#f4efea", 
    // inputBorder: "#cccccc",
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#353331", backgroundDisabled: "#423d37", contrast: "#FFFFFF", invertedContrast: "#261e13", input: "#5a4d3f", 
    // inputBorder: "#cccccc",    
    inputSecondary: "#cccccc", tertiary: "#473e35", text: "#fff", textDisabled: "#716a61", textSubtle: "#b369ff", activeButton: "#397f49", borderColor: "#63584b", card: "#130119", nav: "#130119", gradients: {
...
exports.HorizentalMenu = HorizentalMenu;
